...
```{r eval=TRUE} 
sRGES=sRGES=.eh[['EH7278']] #load example res from octad.db
?res_example
sRGES=sRGES=.eh[['EH7279']] #load example sRGES from octad.db
?sRGES_example
```

Please note, this is a database-like package for the main package octad which can be obtained [here](https://github.com/Bin-Chen-Lab/octad)
After the package will be accepted to the bioconductor, it will be available on the [bioconductor website](https://bioconductor.org/)
# Session information
